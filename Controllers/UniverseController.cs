...
namespace SuperHeroAPI.Controllers
{
    ...
    public class UniverseController : ControllerBase
    {
        ...
        //get all universes
        [HttpGet]
        public async Task<ActionResult<List<UniverseDTO>>> Get()
        {
            var universes = await _context.Universes.Include(universe => universe.SuperHeroes).ToListAsync();
            return _mapper.Map<List<UniverseDTO>>(universes);
        }

        //get a single universe by id
        [HttpGet("{id:int}")]
        public async Task<ActionResult<UniverseDTO>> Get([FromRoute] int id)
        {
            ...
            return await Task.FromResult(_mapper.Map<UniverseDTO>(universe));
        }
        ...
        //delete a universe
        [HttpDelete("{id:int}")]
        public async Task<ActionResult<UniverseDTO>> Delete([FromRoute] int id)
        {
        ...
        [HttpGet("name/{name}")]
        public async Task<ActionResult<List<UniverseDTO>>> GetByName([FromRoute] string name)
        {
